...
type GetUsersResponse struct {
	...
	Surnames []string `protobuf:"bytes,2,rep,name=surnames,proto3" json:"surnames,omitempty"`
}
...
func (x *GetUsersResponse) GetSurnames() []string {
	if x != nil {
		return x.Surnames
	}
	return nil
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x75, 0x72, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x72, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x32, 0xad, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0e, 0x5a, 0x0c, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	8, // 4: auth.Auth.GetUsers:input_type -> auth.GetUsersRequest
	...
	7, // 8: auth.Auth.GetUser:output_type -> auth.GetUserResponse
	9, // 9: auth.Auth.GetUsers:output_type -> auth.GetUsersResponse
